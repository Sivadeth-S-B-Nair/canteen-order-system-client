...
export const restaurantAdminDefault = {
  name: "",
  email: "",
  password: "",
  restaurantId: "",
...
export const forgotPasswordDefault = { email: "" };
...
export const resetPasswordDefault = { newPassword: "", confirmPassword: "" };
...
export const changePasswordDefault = {
  currentPassword: "",
  newPassword: "",
  confirmPassword: "",
};
