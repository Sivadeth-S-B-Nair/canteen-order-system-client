...
import { applyPromo, clearPromo, setPromoLoading, setPromoError } from '@/store/slices/promoSlice';
...
export default function PromoCodeInput({ restaurantId, subtotal }) {
  ...
  const handleApply = async () => {
    ...
    try {
      ...
      dispatch(setPromoError(err.response?.data?.message || 'Invalid promo code'));
    }
  };
